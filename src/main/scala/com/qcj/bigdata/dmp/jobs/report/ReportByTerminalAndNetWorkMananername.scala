...
/**
  * 终端设备：
  *   联网方式networkmannername
  */
object ReportByTerminalAndNetWorkMananername {
  def main(args: Array[String]): Unit = {
    ...
    val conf  = new SparkConf()
      .setAppName("ReportByTerminalAndNetWorkMananername")
      .setMaster("local[2]")
    ...
    retDF.write.mode(SaveMode.Append).jdbc(url,"r_1807_networkmannername",properties)
    spark.stop()
  }
}
